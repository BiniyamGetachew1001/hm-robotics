...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-[#050505] pt-32 overflow-hidden border-t-2 border-coffee/10">

      {/* Scroll to Top Trigger - Floating or Layout based */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
        <button
          onClick={scrollToTop}
          className="group relative bg-void border border-bronze/30 px-6 py-3 font-orbitron text-xs tracking-[0.2em] text-bronze hover:text-cream hover:border-bronze transition-all overflow-hidden"
        >
