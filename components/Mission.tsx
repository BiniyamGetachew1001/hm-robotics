...
const Mission: React.FC = () => {
  return (
    <section id="mission" className="py-24 px-6 bg-void relative overflow-hidden">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 max-w-7xl">
        ...
        >
          ...
          <p className="text-latte text-lg md:text-xl leading-relaxed max-w-xl border-l-2 border-coffee pl-6">
